...
from blade.fns.tools import metadata, translate
...
from . import inline_mention, is_url_ok, json_parser, mediainfo, blade_cmd


@blade_cmd(pattern="tr( (.*)|$)", manager=True)
async def _(event):
...
@blade_cmd(pattern="bots( (.*)|$)", groups_only=True, manager=True)
async def _(ult):
