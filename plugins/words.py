...
from blade.fns.misc import get_synonyms_or_antonyms
from blade.fns.tools import async_searcher

from . import get_string, blade_cmd


@blade_cmd(pattern="meaning( (.*)|$)", manager=True)
