...
from . import eod, eor, get_string, mediainfo, blade_cmd
...
@blade_cmd(pattern="setbio( (.*)|$)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@blade_cmd(pattern="setname ?((.|//)*)", fullsudo=True)
async def _(ult):
    ok = await ult.eor("...")
...
@blade_cmd(pattern="setpic$", fullsudo=True)
async def _(ult):
    if not ult.is_reply:
...
@blade_cmd(pattern="delpfp( (.*)|$)", fullsudo=True)
