...
from blade.startup.loader import load_addons

from . import LOGS, async_searcher, eod, get_string, safeinstall, blade_cmd, un_plug


@blade_cmd(pattern="install", fullsudo=True)
...
@blade_cmd(pattern="getaddons( (.*)|$)", fullsudo=True)
