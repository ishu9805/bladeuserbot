...
from blade.dB.mute_db import is_muted, mute, unmute
from blade.fns.admins import ban_time

from . import asst, eod, get_string, inline_mention, blade_x_userbot_cmd, blade_cmd
...
async def startmute(event):
    ...
    if input_ := event.pattern_match.group(1).strip():
        ...
        if reply.out or userid in [blade_x_userbot_cmd.me.id, asst.me.id]:
