...
from blade.fns.tools import get_google_images, metadata
...
async def hbd(event):
    ...
    if event.reply_to_msg_id:
        ...
        name = blade_x_userbot_cmd.me.first_name
...
@blade_cmd(pattern="q( (.*)|$)", manager=True, allow_pm=True)
