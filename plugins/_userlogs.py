...
from blade.dB.botchat_db import tag_add, who_tag
...
if udB.get_key("TAG_LOG"):
    ...
    @blade_x_userbot_cmd.on(events.MessageEdited(func=lambda x: not x.out))
    ...
    async def idk(e):
        ...
        if chat and msg:
            try:
                await blade_x_userbot_cmd.send_message(chat, e.message, reply_to=msg)
