...
try:
    ...
    Image = None
from blade.fns.misc import unsplashsearch
from blade.fns.tools import LogoHelper

from . import OWNER_ID, OWNER_NAME, download_file, get_string, mediainfo, blade_cmd


@blade_cmd(pattern="logo( (.*)|$)")
